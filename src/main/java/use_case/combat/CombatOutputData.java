...
public class CombatOutputData {
  ...
  public CombatOutputData(int playerHealth, int opponentHealth, boolean ongoing, boolean playerWon, boolean playerLost,
      int damageToPlayer, int damageToOpponent, int healAmount, String nextPhase, String questionDifficulty,
      String actionType, String defenseType, int pendingEnemyDamage) {

    this(playerHealth, opponentHealth, ongoing, playerWon, playerLost, damageToPlayer, damageToOpponent, healAmount,
        nextPhase, questionDifficulty, actionType, defenseType, pendingEnemyDamage, false, 0, 0);
  }

  // FULL constructor (used for GAME OVER)
  public CombatOutputData(int playerHealth, int opponentHealth, boolean ongoing, boolean playerWon, boolean playerLost,
      int damageToPlayer, int damageToOpponent, int healAmount, String nextPhase, String questionDifficulty,
      String actionType, String defenseType, int pendingEnemyDamage, boolean gameOver, int finalXP, int finalRound) {
