...
public class GameplayInteractor implements GameplayInputBoundary {
  ...
  public void submitAnswer(GameplayInputData inputData) {
    ...
    GameplayOutputData outputData = new GameplayOutputData(isCorrect, questionScore, currentQuestion,
        gameState.getScore(), gameState.hasMoreQuestions());
  ...
  public void getNextQuestion() {
    ...
    GameplayOutputData outputData = new GameplayOutputData(false, // Not an answer submission
        0, // No score yet
        currentQuestion, gameState.getScore(), gameState.hasMoreQuestions());
