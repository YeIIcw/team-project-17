...
public class PreferencesController {
  ...
  public void execute(String category, String difficulty, String type, int numQuestions) {
    ...
    // The PreferencesInteractor handles the question fetching based on the
    // parameters

    PreferencesInputData inputData = new PreferencesInputData(category, difficulty, type, numQuestions);
