...
//    }
    ...
    List<Question> parseQuestionsFromJson(String json) throws JSONException {
        ...
        for (int i = 0; i < questionsArray.length(); i++) {
            ...
            String questionText  = decodeHtmlEntities(obj.getString("question"));  // ADD decodeHtmlEntities
            String correctAnswer = decodeHtmlEntities(obj.getString("correct_answer"));  // ADD decodeHtmlEntities
            ...
            if ("boolean".equals(qType)) {
                ...
                for (int j = 0; j < incorrect.length(); j++) {
                    choices.add(decodeHtmlEntities(incorrect.getString(j)));  // ADD decodeHtmlEntities
                }
                correctIndex = 0;
            }
