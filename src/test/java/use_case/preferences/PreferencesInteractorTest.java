...
class PreferencesInteractorTest {
  ...
  void interactorCallsFetcherAndStoresQuestions() {
    ...
    PreferencesInputBoundary interactor = new PreferencesInteractor(fakeFetcher, gameState, presenter, categoryMap);

    PreferencesInputData inputData = new PreferencesInputData("General Knowledge", "Easy", "Multiple Choice", 1);
